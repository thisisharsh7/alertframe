...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] relative overflow-hidden flex flex-col">
      ...
      {/* Header */}
      <header className="border-b-[3px] border-black bg-white relative z-50">
              ...
              <div className="relative">
                ...
                <div className="md:flex space-x-2 hidden">
                  ...
                  <button
                    ...
                    className="md:block px-3 sm:px-4 py-1.5 sm:py-2 text-[11px] sm:text-[13px] font-bold uppercase tracking-wide border-[3px] border-black bg-white hover:bg-[#FF3366]  hover:text-white transition-all duration-200 active:translate-x-[2px] active:translate-y-[2px]">
                    Sign Out
                  </button>
                </div>
                ...
                {isMenuOpen && (
                  <div className="mobile-menu absolute right-0 top-full mt-2 w-48 border-[3px] border-black bg-white shadow-[4px_4px_0_0_#000] md:hidden z-50">
                    <button
                      ...
                      className="w-full px-4 py-3 text-[13px] font-bold uppercase tracking-wide text-left border-b-[3px] border-black hover:bg-black hover:text-white bg-white transition-all"
                    >
                      Dashboard
                    </button>
                    <button
                      ...
                      className="w-full px-4 py-3 text-[13px] font-bold uppercase tracking-wide text-left hover:bg-[#FF3366] hover:text-white bg-white transition-all"
                    >
                      Sign Out
                    </button>
                  </div>
        ...
        <div className="max-w-[900px] mx-auto relative">
          ...
          <div className="absolute right-[-80px] top-[80px] opacity-[0.12] pointer-events-none hidden xl:block">
            <svg width="380" height="280" viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <circle cx="70" cy="30" r="6" fill="#06B6D4" stroke="#000000" strokeWidth="2" />
          ...
          <div className="mb-16 sm:mb-20 md:mb-24">
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3">
              <button
                ...
                className="px-3 sm:px-4 py-1.5 sm:py-2 text-[12px] sm:text-[13px] font-bold border-[2px] border-black bg-white hover:bg-[#06B6D4] hover:text-white transition-colors duration-200"
              >
                YC Companies
              </button>
              <button
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div className="border-[3px] border-black bg-white p-6 sm:p-8 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-[50px] h-[50px] sm:w-[60px] sm:h-[60px] bg-[#06B6D4] opacity-40"></div>
              <svg className="w-[48px] h-[48px] sm:w-[56px] sm:h-[56px] mb-4 sm:mb-6 relative z-10" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
